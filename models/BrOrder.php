 ...
 */
class BrOrder extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function getSurplusGruop()
    {
        ...
        $order_detail = BrOrderDetail::findOne(['order_id' => $order_id, 'is_delete' => 0]);
//        if ($this->class_group) {
//            $goods = BrGoodsDetail::findOne(['id' => $this->class_group]);
//        } else {
		$goods = BrGoods::findOne(['id' => $order_detail->goods_id]);
//        }
        $groupNum = BrOrder::find()
