...
class CommonOrderStatistics extends Model
{
     ...
     * @return int
     */
    public function getUserCount($startTime = null, $endTime = null, $mchId = 0)
    {
        ...
        return intval($userCount)?intval($userCount):0;
    }


    public function getMchCount($startTime = null, $endTime = null, $mchId = 0)
    {
