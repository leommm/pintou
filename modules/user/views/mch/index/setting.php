    ...
    <div class="panel-body">
        <form class="auto-form" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="model[longitude]" value="<?= $model->longitude ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="model[latitude]" value="<?= $model->latitude ?>">
                    <div class="fs-sm">门店经纬度可以在地图上选择，也可以自己添加</div>
                </div>
            </div>
            <div class="form-group row">
