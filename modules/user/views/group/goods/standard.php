    ...
    <div class="panel-body">
        <div class="mb-3 clearfix">
            <div class="float-left">
                <a href="<?= $urlManager->createUrl(['user/group/goods/standard-edit','goods_id' => $_GET['goods_id']]) ?>" class="btn btn-primary"><i
                ...
                <tr>
                    ...
                    <td class="nowrap">
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['user/group/goods/standard-edit', 'id' => $goods['id']]) ?>">修改</a>
                        <a class="btn btn-sm btn-danger del"
                           href="<?= $urlManager->createUrl(['user/group/goods/standard-del', 'id' => $goods['id']]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
