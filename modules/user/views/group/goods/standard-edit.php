...
if ($_GET['goods_id']) {
    $returnUrl = $urlManager->createUrl(['user/group/goods/standard', 'goods_id' => $_GET['goods_id']]);
} else {
    $returnUrl = $urlManager->createUrl(['user/group/goods/standard', 'goods_id' => $goods['goods_id']]);
}
?>
<style> 
    .cat-box { 
