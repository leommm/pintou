...
//                    ],
					[
						'name' => '门店设置',
						'route' => 'user/store/shop',
					],
					[
						'name' => '核销员',
						'route' => 'user/user/clerk',
					],
                ],
            ],
			[
				...
				'list' => [
					...
					[
						'name' => '商品分类',
						'route' => 'user/group/goods/cat',
					],
					[
						'name' => '拼团订单',
						'route' => 'user/group/order/index',
					],
					[
						'name' => '售后订单',
						'route' => 'user/group/order/refund',
					],
				],
			],
//			[
//				'name' => '专场活动',
//				'icon' => 'icon-special',
//				'route' => 'user/special/goods/index',
//				'list' => [
//					[
//						'name' => '团购商品',
//						'route' => 'user/special/goods/index',
...
//					[
//						'name' => '商品分类',
//						'route' => 'user/special/goods/cat',
//					],
//					[
//						'name' => '团购订单',
//						'route' => 'user/special/order/index',
//					],
//					[
//						'name' => '售后订单',
//						'route' => 'user/special/order/refund',
//					],
//				],
//			],
//			[
//				'name' => '专场活动',
//				'icon' => 'icon-community',
//				'route' => 'user/community/goods/index',
//				'list' => [
//					[
//						'name' => '专场商品',
//						'route' => 'user/community/goods/index',
...
////					[
////						'name' => '商品分类',
////						'route' => 'user/community/goods/cat',
////					],
//					[
//						'name' => '专场订单',
//						'route' => 'user/community/order/index',
//					],
//					[
//						'name' => '售后订单',
//						'route' => 'user/community/order/refund',
//					],
//				],
//			],
//			[
//				'name' => '抢工厂',
//				'icon' => 'icon-factory',
//				'route' => 'user/factory/goods/index',
//				'list' => [
//					[
//						'name' => '团购商品',
//						'route' => 'user/factory/goods/index',
...
//					[
//						'name' => '商品分类',
//						'route' => 'user/factory/goods/cat',
//					],
//					[
//						'name' => '团购订单',
//						'route' => 'user/factory/order/index',
//					],
//					[
//						'name' => '售后订单',
//						'route' => 'user/factory/order/refund',
//					],
//				],
//			],
//			[
//				'name' => '砍价管理',
//				'icon' => 'icon-bargain',
//				'route' => 'user/bargain/goods/index',
//				'list' => [
//					[
//						'name' => '砍价商品',
//						'route' => 'user/bargain/goods/index',
...
////					[
////						'name' => '商品分类',
////						'route' => 'user/bargain/goods/cat',
////					],
//					[
//						'name' => '砍价订单',
//						'route' => 'user/bargain/order/index',
//					],
//					[
//						'name' => '售后订单',
//						'route' => 'user/bargain/order/refund',
//					],
//				],
//			],
            [
