...
namespace app\modules\api\controllers\factory;

use app\modules\api\controllers\Controller;
use app\models\FtCat;
use app\modules\api\models\group\FtGoodsForm;
...
class IndexController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$ftGoods = new FtGoodsForm();
		$ftGoods->store_id = $this->store_id;
		$ftGoods->user_id = \Yii::$app->user->id;
		$goods = $ftGoods->getList();
