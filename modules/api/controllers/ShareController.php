...
class ShareController extends Controller
{
    ...
    public function actionSubimit(){
        $user = \Yii::$app->user->id;
        $a=\Yii::$app->db->createCommand('INSERT INTO `cshopmall_share` (`user_id`,`status`,`store_id`,`addtime`) VALUES (:user_id,:status,:store_id,:addtime)', [
            ':user_id' => $user,
            ':status'=>1,
        ...
        $update=\Yii::$app->db->createCommand()->update('cshopmall_user', ['is_distributor' => 1,'time'=>time()], "id = {$user}")->execute();
