...
use app\models\FtGoodsPic;
use app\models\FtOrder;
use app\models\FtOrderComment;
use app\models\FtOrderDetail;
use app\models\User;
use app\modules\api\models\ApiModel;
use yii\data\Pagination;

class FtGoodsForm extends ApiModel
{
    public $page = 0;
    public $store_id;
    ...
    public function getList()
    {
        ...
        foreach ($list as $key => $goods) {
            $list[$key]['groupList'] = FtOrderDetail::find()
                ->select([
                    'u.avatar_url'
                ])
                ->alias('od')
                ->andWhere(['od.goods_id'=>$goods['id']])
                ->leftJoin(['o'=>FtOrder::tableName()], 'o.id=od.order_id')
                ...
                ->asArray()
                ->all();
            $ptGoodsFind = FtGoods::find()->where(['id'=>$goods['id']])->one();
    ...
    public function getInfo()
    {
        ...
        $comment = FtOrderComment::find()
            ...
            ->leftJoin(['od'=>FtOrderDetail::tableName()], 'od.id=c.order_detail_id')
        ...
        return [
            ...
            'data'  => [
                ...
                'comment'      => $comment,
                'commentNum'      => FtOrderComment::getCount($info['id'], $this->store_id),
            ],
        ];
    }
