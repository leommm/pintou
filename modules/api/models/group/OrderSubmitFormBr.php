...
class OrderSubmitFormBr extends ApiModel
{
    public $store_id;
    public $user_id;
...
//        $order->name = $address->name;
        ...
        if ($order->save()) {
            foreach ($goods_list as $goods) {
                $order_detail = new BrOrderDetail();
                ...
                $_goods = BrGoods::findOne($goods->goods_id);
...
//                ->count();
            $orderNum = BrOrder::getCount($goods->id,$this->user_id);
