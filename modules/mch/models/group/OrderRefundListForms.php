...
class OrderRefundListForms extends MchModel
{
    public $store_id;
    public $user_id;
    public $keyword;
    ...
    public function search($mch_id = 0)
    {
        if (!$this->validate()) {
            return $this->errorResponse;
        }
        $query = CmOrderRefund::find()->alias('or')
            ->leftJoin(['o' => CmOrder::tableName()], 'o.id=or.order_id')
            ->leftJoin(['od' => CmOrderDetail::tableName()], 'od.id=or.order_detail_id')
