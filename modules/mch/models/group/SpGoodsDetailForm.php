...
class SpGoodsDetailForm extends MchModel
{
    public $store_id;
    public $colonel;
    public $group_num;
    ...
    public function search()
    {
        ...
        $query = CmGoods::find()->where(['store_id' => $this->store_id, 'is_delete' => 0]);
    ...
    public function save()
    {
        ...
        $goods = CmGoods::find()->select('attr')->where(['is_delete' => 0, 'id' => $id, 'store_id' => $this->store_id])->asArray()->one();
