...
class FtGoodsDetailForm extends MchModel
{
    public $store_id;
    public $colonel;
    public $group_num;
    ...
    public function search()
    {
        ...
        $query = FtGoods::find()->where(['store_id' => $this->store_id, 'is_delete' => 0]);
    ...
    public function save()
    {
        ...
        $goods = FtGoods::find()->select('attr')->where(['is_delete' => 0, 'id' => $id, 'store_id' => $this->store_id])->asArray()->one();
