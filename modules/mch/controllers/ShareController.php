...
//            $cash->type = 2;
    ...
    public function actionAudit($id = 0){
        $t = \Yii::$app->db->beginTransaction();
        $up = \Yii::$app->db->createCommand()->update('cshopmall_share', ['general_id' =>1], "id = {$id}")->execute();
    ...
    public function actionQxaudit($id = 0){

        $t = \Yii::$app->db->beginTransaction();
        $up = \Yii::$app->db->createCommand()->update('cshopmall_share', ['general_id' =>0], "id = {$id}")->execute();
