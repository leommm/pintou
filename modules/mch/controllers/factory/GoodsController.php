...
namespace app\modules\mch\controllers\factory;
...
class GoodsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $cat_list = FtCat::find()->select('id,name')->andWhere(['store_id' => $this->store->id, 'is_delete' => 0, 'mch_id' => 0])->orderBy('sort ASC')->asArray()->all();
    ...
    {
        $cat = FtCat::findOne(['id' => $id, 'is_delete' => 0, 'store_id' => $this->store->id, 'mch_id' => 0]);
        if (!$cat) {
            $cat = new FtCat();
        }
    ...
    {
        $goods = FtGoods::findOne(['id' => $id, 'is_delete' => 0, 'store_id' => $this->store->id, 'mch_id' => 0]);
