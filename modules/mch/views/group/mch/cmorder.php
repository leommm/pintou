    ...
    <div class="panel-body">
                                ...
                                <div class="dropdown float-right ml-2">
                                    ...
                                    <div class="dropdown-menu" style="min-width:8rem">
                                        <a class="dropdown-item"
                                           href="<?= $urlManager->createUrl(['mch/group/mch/cm-order']) ?>">所有订单</a>
                                        <a class="dropdown-item"
                                           href="<?= $urlManager->createUrl(['mch/group/mch/cm-order', 'offline' => 1]) ?>">非自提</a>
                                        <a class="dropdown-item"
                                           href="<?= $urlManager->createUrl(['mch/group/mch/cm-order', 'offline' => 2]) ?>">自提</a>
                                    </div>
                                </div>
            ...
            <ul class="nav nav-tabs status">
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == -1 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'])) ?>">全部</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 0 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'], $condition, ['status' => 0])) ?>">未付款<?= $store_data['status_count']['status_0'] ? '(' . $store_data['status_count']['status_0'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 1 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'], $condition, ['status' => 1])) ?>">待发货<?= $store_data['status_count']['status_1'] ? '(' . $store_data['status_count']['status_1'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 2 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'], $condition, ['status' => 2])) ?>">已发货<?= $store_data['status_count']['status_2'] ? '(' . $store_data['status_count']['status_2'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 6 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'], $condition, ['status' => 6])) ?>">拼团中<?= $store_data['status_count']['status_6'] ? '(' . $store_data['status_count']['status_6'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 3 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'], $condition, ['status' => 3])) ?>">已完成<?= $store_data['status_count']['status_3'] ? '(' . $store_data['status_count']['status_3'] . ')' : null ?></a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 5 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'], $condition, ['status' => 5])) ?>">已取消<?= $store_data['status_count']['status_5'] ? '(' . $store_data['status_count']['status_5'] . ')' : null ?></a>
                </li>

                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 4 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/cm-order'], $condition, ['status' => 4])) ?>">拼团失败</a>
                </li>
        ...
        <table class="table table-bordered bg-white">
            <tr>
                ...
                <th class="order-tab-5" style="display: none">操作</th>
            </tr>
        </table>
            ...
            <div class="order-item">
                <table class="table table-bordered bg-white">
                    ...
                    <tr>
                        ...
                        <td class="order-tab-5" style="display: none">
                            <?php if ($order_item['apply_delete'] == 2): ?>
                                <?php if ($order_item['is_cancel'] == 0): ?>
                                    <div class="mb-2">
