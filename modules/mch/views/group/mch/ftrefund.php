...
$urlHandle = $urlManager->createUrl(['mch/group/mch/refund-handle']);
?>
<style>
    .order-item {
    ...
    <div class="panel-body">
            ...
            <ul class="nav nav-tabs status">
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == -1 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(['mch/group/mch/cm-refund']) ?>">全部</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 0 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(['mch/group/mch/cm-refund', 'status' => 0]) ?>">待处理</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $status == 1 ? 'active' : null ?>"
                       href="<?= $urlManager->createUrl(['mch/group/mch/cm-refund', 'status' => 1]) ?>">已处理</a>
                </li>
            </ul>
        </div>
        <table class="table table-bordered bg-white">
            <tr>
                ...
                <th class="order-tab-4" style="display: none">操作</th>
            </tr>
        </table>
            ...
            <div class="order-item">
                <table class="table table-bordered bg-white">
                    ...
                    <tr>
                        ...
                        <td class="order-tab-4" style="display: none">
                            <?php if ($order_item['refund_status'] == 0) : ?>
                                <?php if ($order_item['refund_type'] == 1) : ?>
                                    <div class="mb-2">
