    ...
    <div class="panel-body">
        ...
        <div class="mb-3 clearfix">
            <div class="float-left">
                <a style="display: none" href="<?= $urlManager->createUrl(['mch/group/goods/goods-edit']) ?>" class="btn btn-primary"><i
                ...
                <div class="dropdown float-right ml-2" style="display: none">
                ...
                <div class="dropdown float-right ml-2">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                        ...
                        <a class="dropdown-item"
                           href="<?= $urlManager->createUrl(['mch/group/mch/br-goods']) ?>">全部类型</a>
                        <?php foreach ($cat_list as $index => $value) : ?>
                            <a class="dropdown-item"
                               href="<?= $urlManager->createUrl(array_merge(['mch/group/mch/br-goods'], $_GET, ['cat' => $value['id']])) ?>"><?= $value['name'] ?></a>
                        <?php endforeach; ?>
                    </div>
                </div>
            </div>
        ...
        <table class="table table-bordered bg-white">
            ...
            <tr>
                <th style="text-align: left">
                    <!--<span><input type="checkbox" class="goods-all"></span>-->
                    &nbsp;&nbsp;ID</th>
                <th>商品类型</th>
...
<!--            <col style="width: 18%">-->
            ...
            <?php foreach ($list as $index => $goods) : ?>
                <tr>
                    ...
                    <td class="nowrap"><?= $goods['original_price'] ?></td>
                    ...
                    <td class="nowrap">
                        <?php if ($goods['status'] == 1) : ?>
                            ...
                            <!--<a href="javascript:" onclick="upDown(<?= $goods['id'] ?>,'down');"
                               ...
                               data-toggle="tooltip" data-placement="top" title="点击设置下架">-->
                                <span class="badge badge-primary">上架</span>
                            <!--</a>-->
                        <?php else : ?>
                        <!--<a href="javascript:" onclick="upDown(<?= $goods['id'] ?>,'up');"
                               class="badge badge-info"
                               data-toggle="tooltip" data-placement="top" title="点击设置上架">-->
                            <span class="badge badge-info">下架</span>
                        <!--</a>-->
                    ...
                    <td class="nowrap">
                        <?php if ($goods['is_hot'] == 1) : ?>
                            <!--<a onclick="setHot(<?= $goods['id'] ?>,'nohot');"
                               ...
                               href="javascript:;"
                               data-toggle="tooltip" data-placement="top" title="点击取消商品热销">-->
                                <span class="badge badge-danger">热销</span>
                            <!--</a>-->
                        <?php else : ?>
                            <!--<a onclick="setHot(<?= $goods['id'] ?>,'hot');" href="javascript:;"
                               class="badge badge-primary"
                               data-toggle="tooltip" data-placement="top" title="点击设置为热销">-->
