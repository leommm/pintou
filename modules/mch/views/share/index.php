                ...
                <tr>
                    ...
                    <td>
                        <?php if ($value['order_count'] && $value['order_count'] > 0) : ?>
                            <div>
                                <a target="_blank"
                                   href="<?= $urlManager->createUrl(['mch/order/index', 'user_id' => $value['user_id']]) ?>">商城订单：<?= $value['order_count'] ?></a>
                            </div>
                        <?php endif; ?>
                        <?php if ($value['ms_order_count'] && $value['ms_order_count'] > 0) : ?>
                            <div>
                                <a target="_blank"
                                   href="<?= $urlManager->createUrl(['mch/miaosha/order/index', 'user_id' => $value['user_id']]) ?>">秒杀订单：<?= $value['ms_order_count'] ?></a>
                            </div>
                        <?php endif; ?>
                        <?php if ($value['pt_order_count'] && $value['pt_order_count'] > 0) : ?>
                            <div>
                                <a target="_blank"
                                   href="<?= $urlManager->createUrl(['mch/group/order/index', 'user_id' => $value['user_id']]) ?>">拼团订单：<?= $value['pt_order_count'] ?></a>
                            </div>
                        <?php endif; ?>
                        <?php if ($value['yy_order_count'] && $value['yy_order_count'] > 0) : ?>
                            <div>
                                <a target="_blank"
                                   href="<?= $urlManager->createUrl(['mch/book/order/index', 'user_id' => $value['user_id']]) ?>">预约订单：<?= $value['yy_order_count'] ?></a>
                            </div>
                        <?php endif; ?>
                    </td>
                    <td>
