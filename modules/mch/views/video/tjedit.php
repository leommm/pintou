...
$cat_id = Yii::$app->request->get('cat_id', 1);
...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post"  return="<?= $urlManager->createUrl(['mch/video/tjedit']) ?>">
            ...
            <div class="form-group row" >
                ...
                <div class="col-9">
                    <div class="video-picker" data-url="<?= $urlManager->createUrl(['upload/video']) ?>">
                        ...
                        <a class="video-check"
                           href="<?= $model['url'] ? $model['video_url'] : "javascript:" ?>"
            ...
            <?php if ($cat_id == 2) : ?>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-control" type="text" name="model[content]" value="<?= date('Y-m-d,H:i',$model['addtime']) ?>"></div>
                    </div>
                </div>
            <?php endif; ?>
            <div class="form-group row">
