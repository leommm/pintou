            ...
            <?php foreach ($list as $item) : ?>
                <table class="table table-bordered hongbao-item">
                    ...
                    <tr>
                        <td colspan="3">
                        <span class="mr-4">发起人：
                        <span style="min-width: 100px;max-width: 250px;display: inline-block;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;vertical-align: bottom"><?= $item['nickname'] ?></span>
                        </span>
