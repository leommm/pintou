...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">模板消息ID</label>
                </div>
                <div class="col-sm-6">
                    <input class="form-control" name="tpl_msg_id" value="<?= $model->tpl_msg_id ?>">
                    <div class="text-muted fs-sm">红包成功瓜分后发送的小程序模板消息id，<a href="javascript:" data-toggle="modal"
                                                                         data-target="#tpl_id_demo">模板示例</a></div>
                </div>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="tpl_id_demo">
    <div class="modal-dialog" role="document">
        <div class="panel" data-dismiss="modal">
            <div class="panel-body"><img style="display: table;max-width: 100%;margin: 0 auto" src="<?=Yii::$app->request->baseUrl?>/statics/images/fxhb/tplmsg.png"></div>
        </div>
    </div>
</div>
