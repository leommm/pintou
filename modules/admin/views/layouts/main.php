...
$logo = $logo ? $logo : Yii::$app->request->baseUrl . '/statics/admin/images/logos.png';

$copyright = Option::get('copyright', 0, 'admin');
$copyright = $copyright ? $copyright : '©2017 <a href="http://tt.tryine.com" target="_blank">CSHOP</a>';
...
<!--end-->
<nav class="navbar navbar-expand-md  navbar-light bg-white" style="border-bottom: 1px solid #e3e3e3; background:#2589ff ;">
    <div class="container">
